        ...
        works: [
            {
                ...
                name: 'NATOS®',
                date: 'juin 2024',
                summary: 'Site web de vente d\'huiles d\'olive portugaise d\'excellence',
                description: "Site web de vente d'huiles d'olive portugaise d'excellence. Ce projet a été réalisé en 1 mois dans le cadre d'un stage au sein de l'entreprise BOA&BOM Food Concept, qui distribue la marque NATOS®. L'objectif était de créer un site web de e-commerce en utilisant Shopify. Ce fut ma première expérience avec ce CMS et je suis particulièrement fier du résultat. Sur ce site, il est possible de découvrir les produits phares de NATOS®, et d'acheter les huiles d'olives NATOS® Origine.",
                image: '/imgs/natos.png',
                link: 'https://natos.fr',
                technos: ['shopify']
            },
            {
